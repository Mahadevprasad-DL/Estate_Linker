...
if(isset($_REQUEST['calc'])) {
    ...
    // Validate if amount and interest are numeric
    if (is_numeric($amount) && is_numeric($int)) {
        $interest = $amount * $int / 100;
        $pay = $amount + $interest;
    } else {
        // If not numeric, set error messages or handle accordingly
        $interest = "Invalid input";
        $pay = "Invalid input";
    }
}
?>

            ...
            <div class="row">
                <div class="col-md-8">
                    <ul class="top-contact list-text-white d-table">
                        <li>FlatValue Services and Rentals</li> <!-- Changed <p> to <li> -->
                    </ul>
                </div>
                <div class="col-md-4">
                    <div class="top-contact float-right">
                        <ul class="list-text-white d-table">
                            ...
                            <li><i class="fas fa-user text-primary mr-1"></i><a href="register.php"> Register</a></li> <!-- Closed the <a> tag properly -->
                            <li class="dropdown">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light p-0">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="location.html">New Builder Projects</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="property.php"">Check Instalment</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="http://127.0.0.1:5000">Price Prediction</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="https://app.droxy.ai/agent/67347793188ac84371e2c0c9">ChatBox</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="style.html">Home interiror</a>
                                </li>
